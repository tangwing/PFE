...
#define MemLimit 1024.0 //Not used
...
int main(int argc, char*argvs[])
{
	...
	///I had tried to make the time limit dynamic according to the performance of hosting pc. (because cplex can do multithreading)
	int iTimeLimit = CalculateTimeLimit();
	///But finally I decided to use 200 directly statically.
	iTimeLimit = 200;
    printf("TimeLimit : %d\n", iTimeLimit);
...
//	GetData("Donnees/donnees4_4.dat");
	...
	try
    {
		...
		if(CONFIG)
		{
			///Here come the differences between this program and the TimIndexedFormulation
