...
bool MIP_START = false;	//Whether enable AddMIPStart. When enabled, use the solution of H2 as a start solution in MIP after Preprocessing
...
void main(void)
{
 ...
 for (i=0;i<8;i++)
 {
	  ...
	  for (j=0;j<iterations;j++)
	  {
	   ...
	   {
		   printf("Instance no feasible, skip...\n");
		   continue;
	   }
	   ...
	   if (DEBUG)
	   {
		...
		LogCut2Level("pre_cut2.csv" ,i,j, cut2Level, pre);
	  }
  }
}
